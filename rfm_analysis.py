...
if file_uploaded is None:
    ...
    st.error("Please upload your data file.")
    ...
    if 'Patient ID' not in df.columns or 'Date' not in df.columns or 'Revenue ($)' not in df.columns:
        st.warning("Please make sure the uploaded file follows the template format")
